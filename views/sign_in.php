...
echo "<label for=\"text\"><b>First Name: </b><span >*</span></label>\n";
echo "<label for=\"text\" style=\"margin-left:26%\"><b>Last Name: </b><span >*</span></label><br>\n";
echo "<input type=\"text\" placeholder=\"First Name\" name=\"firstName\" id=\"firstName\" class=\"name-input\"required>\n";
echo "\n";
echo "<input type=\"text\" placeholder=\"Last Name\" name=\"lastName\" id=\"lastName\" class=\"name-input\"required><br>\n";
...
echo "<button type=\"submit\" id=\"checks\" class=\"but\">Sign Up</button><br>\n";
